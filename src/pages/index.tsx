  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to edtech - Where students, teachers, and admins collaborate. Experience seamless registration, login, and online class creation for a comprehensive learning journey."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to edtech - Where students, teachers, and admins collaborate. Experience seamless registration, login, and online class creation for a comprehensive learning journey.`}
            </Text>
            <Box
